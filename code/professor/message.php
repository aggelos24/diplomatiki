...
$result = $link->query("SELECT count(*) AS inbox FROM message WHERE to_user='".PROFESSOR_USERNAME."' GROUP BY to_user");
...
$limit = ($pagenum - 1) * 10;
$result = $link->query("SELECT * FROM message WHERE to_user='".PROFESSOR_USERNAME."' ORDER BY id DESC LIMIT ".$limit.",10");
