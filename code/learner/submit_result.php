...
if ($row["section_number"] != NULL) {																										//αν το τεστ είναι σε κάποια συγκεκριμένη ενότητα
	$score = $_POST["question_1"]+$_POST["question_2"]+$_POST["question_3"]+$_POST["question_4"]+$_POST["question_5"];						//υπολογισμός βαθμολογίας
	if (($score >= 4) and ($_SESSION["session_llevel"] != 6)) {																				//αν η βαθμολογία είναι μεγαλύτερη ή ίση του 4 και το επίπεδο δεν είναι 6
		...
		$link->query ("UPDATE user SET level=".$_SESSION["session_llevel"]." WHERE username='".$_SESSION["session_lusername"]."'");			//ενημέρωση πίνακα user για το νέο επίπεδο
	}
